...
public class CsDbAdapter {
	...
	// *** Main database methods
	   ...
	   /**
	    * Opens the database and makes it available for writinDB.
	    */
	   ...
	   public Campaign getCampaignById(String id) {
		   ...
		   Task task = campaign.new Task(cur.getString(cur.getColumnIndex(DB.NAME)),
		   ...
		   //TODO get all questions associated with this campaign.
		   //Store them in the form, and return the campaign. Now test...
