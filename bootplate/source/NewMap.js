enyo.kind({
	...
	//this.straction.events.register("zoomend", null, enyo.bind(this, "makeFilter"));
	//this.straction.events.register("moveend", null, enyo.bind(this, "makeFilter"));
	//this.log(this.straction.getProjection());
    },
    locSuccess: function (a, b) {
	Data.setLocationData(b.coords);
	if(true || !this.panZoomed) {
	    this.centerMap();
	}
        return true;
    },
