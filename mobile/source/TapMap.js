enyo.kind({
    ...
    components: [
		...
		{name: "mapCont", style: "height: 400px; width: 400px; margin-left: auto; margin-right: auto; overflow: hidden;"},
	...
	renderMap: function(inSender, inEvent) {
		this.lastClicked=0;
		this.tapMap = L.map(this.$.mapCont.id, {maxZoom: 17}).setView([44.981313, -93.266569], 13);
		//L.tileLayer("http://tile.stamen.com/toner-lite/{z}/{x}/{y}.png", {
		L.tileLayer("http://{s}.tile.osm.org/{z}/{x}/{y}.png", {attribution: "Data by OpenStreetMap, under CC BY SA.",updateWhenIdle: true,detectRetina: true, noWrap: true}).addTo(this.tapMap);
	...
	clickListener: function(inSender, inEvent) {
		...
		var url = "FIND NEW GEOCODE URL" /* + type + bounded + vbox */ + end;
	...
	locSuccess: function () {
		//var coords = b.coords;
		var coords = Data.getLocationData();

		var latlng = new L.LatLng(coords.latitude.toPrecision(8), coords.longitude.toPrecision(8));
