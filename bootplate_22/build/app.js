...
classes: "light-background onyx-popup",
centered: !0,
floating: !0,
modal: !0,
scrim: !0,
...
r.go().response(this, "renderResponse"), this.$.panels.$.animator.setDuration(150);
},
renderResponse: function(e, t) {
...
var n = this.$.panels.getIndex();
this.log(), this.waterfall("onSnapping", undefined, n);
},
checkSides: function() {
...
locPlot: function(e) {
this.locations = e, this.points = [], this.polygons = [], this.addMarkers();
},
inside: function(e) {},
...
loc = e.latlng, loc.lat = loc.lat.toPrecision(8), loc.lng = loc.lng.toPrecision(8), enyo.Signals.send("onPinClicked", loc);
},
